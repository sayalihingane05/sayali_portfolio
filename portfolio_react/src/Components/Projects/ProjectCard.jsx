    ...
    <div className="w-full max-w-sm bg-[#283476] rounded-2xl shadow-xl overflow-hidden hover:scale-105 transition duration-300">
      ...
      <div className="p-5 flex flex-col justify-between h-64">
        <div>
          ...
          <p className="text-sm text-blue-300 leading-relaxed">{main}</p>
        </div>
        <div className="flex gap-4 mt-5">
          <button className="flex-1 bg-[#465697] text-white py-2 rounded-full hover:opacity-90 transition">Demo</button>
          <button className="flex-1 bg-[#465697] text-white py-2 rounded-full hover:opacity-90 transition">Source Code</button>
        </div>
      </div>
    </div>
  );
